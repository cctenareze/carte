...
lyr_Commercesdeservices_2.set('fieldLabels', {'code posta': 'no label', 'commune': 'inline label', 'qui': 'inline label', 'quoi': 'inline label', 'catégorie': 'inline label', 'obs': 'inline label', 'adresse': 'inline label', 'numéro': 'inline label', 'mail': 'inline label', 'Site': 'inline label', });
lyr_Sant_3.set('fieldLabels', {'code posta': 'no label', 'commune': 'inline label', 'qui': 'inline label', 'quoi': 'inline label', 'catégorie': 'inline label', 'obs': 'inline label', 'adresse': 'inline label', 'numéro': 'inline label', 'mail': 'inline label', 'Site': 'inline label', });
lyr_Commercesdedtail_4.set('fieldLabels', {'code posta': 'no label', 'commune': 'inline label', 'qui': 'inline label', 'quoi': 'inline label', 'catégorie': 'inline label', 'obs': 'inline label', 'adresse': 'inline label', 'numéro': 'inline label', 'mail': 'inline label', 'Site': 'inline label', });
